...
description_block = """Custom JSON Encoder for Python utilising functools.singledispatch to support custom encoders for both Python's built-in classes and user-created classes, without as much legwork.
...
source:
  url: "https://pypi.io/packages/source/s/sdjson/sdjson-{__version__}.tar.gz"
...
about:
  ...
  doc_url: https://singledispatch-json.readthedocs.io
  dev_url: https://github.com/domdfcoding/singledispatch-json
